...
public class ChartHelper extends JPanel {
	...
	private XYDataset createDataset() {
		...
		Set<UserEquipment> users = shannonData.stream().flatMap(s -> s.getUserEquipment().stream())
	...
	private JFreeChart createChart(final XYDataset dataset) {
		...
		JFreeChart chart = ChartFactory.createXYLineChart("JTCOMP_VPNOMA", "snrdb", "Capacity", dataset,
